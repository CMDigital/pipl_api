...
class SearchAPIRequest
    ...
    HEADERS = {'User-Agent' => 'pipl_api/ruby/%s' % PiplApi::VERSION}
    ...
    def append_priority_rule(params={})
        ...
        # category -- str, any one of the categories defined in
        #             pipl_api.data.source.Source.categories.
...
class SearchAPIResponse
    ...
    #
    # - A person (pipl_api.data.containers.Person) that is the deta object
    ...
    #
    # - A list of records (pipl_api.data.containers.Record) that fully/partially
